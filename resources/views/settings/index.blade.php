    ...
    <div class="max-w-12xl mx-auto p-6">
        <form action="{{ route('settings.update') }}" method="POST">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <input type="text" name="nama_gym" value="{{ \App\Models\Setting::getValue('nama_gym') }}"
                                ...
                                placeholder="Contoh: Ahmad Fitness Center">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="google_maps_url"
                                ...
                                class="w-full mt-1 p-2.5 border rounded-lg focus:ring-emerald-500"
                        ...
                        <div>
                            ...
                            <textarea name="jam_operasional" rows="3"
                                class="w-full mt-1 p-2.5 border rounded-lg focus:ring-emerald-500">{{ \App\Models\Setting::getValue('jam_operasional') }}</textarea>
                        </div>
                        <div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <div class="relative" x-data="{ show: false }">
                                <input :type="show ? 'text' : 'password'" name="wa_api_key"
                        ...
                        <br>
                         <a href="/tes-wa" target="_blank"
                class="bg-blue-500 text-white px-4 py-2 rounded-lg hover:bg-blue-600 transition">
                <i class="fa-solid fa-paper-plane"></i> Tes Koneksi WA
            </a>

                        <div class="pt-4 border-t border-gray-50 mt-4">
                            <p class="text-xs text-gray-500 mb-2">Status API:
                                <span
                                    class="{{ \App\Models\Setting::getValue('wa_api_key') ? 'text-emerald-500' : 'text-red-400' }} font-bold">
            ...
            <div class="mt-8 flex justify-end">
                <button type="submit"
                    class="bg-emerald-500 hover:bg-emerald-600 text-white px-8 py-3 rounded-xl font-bold transition shadow-lg shadow-emerald-200">

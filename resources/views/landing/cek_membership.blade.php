    ...
    <div class="page-wrapper">
        <div class="layanan-page">
            <div style="text-align:center;margin-bottom:2rem;">
                <h1 style="font-size:clamp(1.6rem,3vw,2.2rem);font-weight:800;">Layanan <span
                        style="color:var(--lime);">Kami</span></h1>
            ...
            <div class="layanan-container">
                <a href="/#layanan"
                    style="display:inline-flex;align-items:center;gap:0.4rem;color:var(--muted);text-decoration:none;font-size:0.85rem;font-weight:500;margin-bottom:1.75rem;transition:color 0.2s;align-self:flex-start;width:100%;max-width:520px;">
                    ← Kembali ke layanan
                </a>
                <div class="cek-card">
                    ...
                    <form method="GET" action="/cek-membership">
                        <div class="search-row">
                            <div class="search-wrap">
                                ...
                                <input type="text" name="search" class="search-input" placeholder="MBR-XXXX atau No WA"
                    ...
                    @isset($member)
                        ...
                        <div style="margin-top: 1rem; text-align: center;">
                            <button id="downloadCard" class="btn-cari"
                                style="background: var(--lime); color: #000; width: 100%; max-width: 600px; height: 1.5rem;">
